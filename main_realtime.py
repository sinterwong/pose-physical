...
reference_video_path = 'data/sholderpress.mp4'
...
while True:
    ...
    result = pose_tracker.process(image=input_frame)
    refer_result = pose_tracker2.process(image=refer_input_frame)

    pose_landmarks = result.pose_landmarks
    refer_pose_landmarks = refer_result.pose_landmarks
